...
func (o *DeleteMsgVpnSequencedTopicOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnSequencedTopicDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
