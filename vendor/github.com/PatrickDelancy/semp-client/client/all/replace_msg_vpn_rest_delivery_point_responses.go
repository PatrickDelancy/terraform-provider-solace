...
func (o *ReplaceMsgVpnRestDeliveryPointOK) GetPayload() *models.MsgVpnRestDeliveryPointResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnRestDeliveryPointDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
