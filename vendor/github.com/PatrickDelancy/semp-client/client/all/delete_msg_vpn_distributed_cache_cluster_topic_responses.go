...
func (o *DeleteMsgVpnDistributedCacheClusterTopicOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnDistributedCacheClusterTopicDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
