...
/* ReplaceMsgVpnDistributedCacheParams contains all the parameters to send to the API endpoint
   for the replace msg vpn distributed cache operation.
...
// WithDefaults hydrates default values in the replace msg vpn distributed cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnDistributedCacheParams) WithDefaults() *ReplaceMsgVpnDistributedCacheParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the replace msg vpn distributed cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnDistributedCacheParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the replace msg vpn distributed cache params
func (o *ReplaceMsgVpnDistributedCacheParams) WithOpaquePassword(opaquePassword *string) *ReplaceMsgVpnDistributedCacheParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the replace msg vpn distributed cache params
func (o *ReplaceMsgVpnDistributedCacheParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamReplaceMsgVpnDistributedCache binds the parameter select
func (o *ReplaceMsgVpnDistributedCacheParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
