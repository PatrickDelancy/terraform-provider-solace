...
/* GetMsgVpnMqttSessionsParams contains all the parameters to send to the API endpoint
   for the get msg vpn mqtt sessions operation.
...
// WithDefaults hydrates default values in the get msg vpn mqtt sessions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnMqttSessionsParams) WithDefaults() *GetMsgVpnMqttSessionsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get msg vpn mqtt sessions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnMqttSessionsParams) SetDefaults() {
	var (
		countDefault = int64(10)
	)

	val := GetMsgVpnMqttSessionsParams{
		Count: &countDefault,
	}
...
// WithOpaquePassword adds the opaquePassword to the get msg vpn mqtt sessions params
func (o *GetMsgVpnMqttSessionsParams) WithOpaquePassword(opaquePassword *string) *GetMsgVpnMqttSessionsParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the get msg vpn mqtt sessions params
func (o *GetMsgVpnMqttSessionsParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamGetMsgVpnMqttSessions binds the parameter select
func (o *GetMsgVpnMqttSessionsParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
...
// bindParamGetMsgVpnMqttSessions binds the parameter where
func (o *GetMsgVpnMqttSessionsParams) bindParamWhere(formats strfmt.Registry) []string {
	whereIR := o.Where
