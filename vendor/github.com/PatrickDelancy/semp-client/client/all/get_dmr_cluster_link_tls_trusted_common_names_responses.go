...
func (o *GetDmrClusterLinkTLSTrustedCommonNamesOK) GetPayload() *models.DmrClusterLinkTLSTrustedCommonNamesResponse {
	return o.Payload
}
...
func (o *GetDmrClusterLinkTLSTrustedCommonNamesDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
