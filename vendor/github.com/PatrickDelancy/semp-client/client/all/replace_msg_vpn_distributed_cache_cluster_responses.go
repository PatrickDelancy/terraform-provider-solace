...
func (o *ReplaceMsgVpnDistributedCacheClusterOK) GetPayload() *models.MsgVpnDistributedCacheClusterResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnDistributedCacheClusterDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
