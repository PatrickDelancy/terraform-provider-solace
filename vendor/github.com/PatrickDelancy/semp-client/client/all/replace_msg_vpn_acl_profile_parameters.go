...
/* ReplaceMsgVpnACLProfileParams contains all the parameters to send to the API endpoint
   for the replace msg vpn Acl profile operation.
...
// WithDefaults hydrates default values in the replace msg vpn Acl profile params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnACLProfileParams) WithDefaults() *ReplaceMsgVpnACLProfileParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the replace msg vpn Acl profile params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnACLProfileParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the replace msg vpn Acl profile params
func (o *ReplaceMsgVpnACLProfileParams) WithOpaquePassword(opaquePassword *string) *ReplaceMsgVpnACLProfileParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the replace msg vpn Acl profile params
func (o *ReplaceMsgVpnACLProfileParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamReplaceMsgVpnACLProfile binds the parameter select
func (o *ReplaceMsgVpnACLProfileParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
