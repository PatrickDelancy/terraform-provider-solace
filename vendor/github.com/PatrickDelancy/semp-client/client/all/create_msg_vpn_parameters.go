...
/* CreateMsgVpnParams contains all the parameters to send to the API endpoint
   for the create msg vpn operation.
...
// WithDefaults hydrates default values in the create msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnParams) WithDefaults() *CreateMsgVpnParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create msg vpn params
func (o *CreateMsgVpnParams) WithOpaquePassword(opaquePassword *string) *CreateMsgVpnParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create msg vpn params
func (o *CreateMsgVpnParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateMsgVpn binds the parameter select
func (o *CreateMsgVpnParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
