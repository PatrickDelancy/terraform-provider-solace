...
func (o *DeleteMsgVpnACLProfilePublishExceptionOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnACLProfilePublishExceptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
