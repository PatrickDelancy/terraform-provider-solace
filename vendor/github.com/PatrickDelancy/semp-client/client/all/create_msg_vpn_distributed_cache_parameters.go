...
/* CreateMsgVpnDistributedCacheParams contains all the parameters to send to the API endpoint
   for the create msg vpn distributed cache operation.
...
// WithDefaults hydrates default values in the create msg vpn distributed cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnDistributedCacheParams) WithDefaults() *CreateMsgVpnDistributedCacheParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create msg vpn distributed cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnDistributedCacheParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create msg vpn distributed cache params
func (o *CreateMsgVpnDistributedCacheParams) WithOpaquePassword(opaquePassword *string) *CreateMsgVpnDistributedCacheParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create msg vpn distributed cache params
func (o *CreateMsgVpnDistributedCacheParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateMsgVpnDistributedCache binds the parameter select
func (o *CreateMsgVpnDistributedCacheParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
