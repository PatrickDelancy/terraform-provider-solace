...
/* GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams contains all the parameters to send to the API endpoint
   for the get msg vpn distributed cache cluster global caching home cluster topic prefixes operation.
...
// WithDefaults hydrates default values in the get msg vpn distributed cache cluster global caching home cluster topic prefixes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) WithDefaults() *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get msg vpn distributed cache cluster global caching home cluster topic prefixes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) SetDefaults() {
	var (
		countDefault = int64(10)
	)

	val := GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams{
		Count: &countDefault,
	}
...
// WithOpaquePassword adds the opaquePassword to the get msg vpn distributed cache cluster global caching home cluster topic prefixes params
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) WithOpaquePassword(opaquePassword *string) *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the get msg vpn distributed cache cluster global caching home cluster topic prefixes params
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamGetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixes binds the parameter select
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
...
// bindParamGetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixes binds the parameter where
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesParams) bindParamWhere(formats strfmt.Registry) []string {
	whereIR := o.Where
