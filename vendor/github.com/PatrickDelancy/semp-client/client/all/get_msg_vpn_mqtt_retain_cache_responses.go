...
func (o *GetMsgVpnMqttRetainCacheOK) GetPayload() *models.MsgVpnMqttRetainCacheResponse {
	return o.Payload
}
...
func (o *GetMsgVpnMqttRetainCacheDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
