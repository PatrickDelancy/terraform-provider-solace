...
func (o *ReplaceMsgVpnTopicEndpointOK) GetPayload() *models.MsgVpnTopicEndpointResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnTopicEndpointDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
