...
func (o *DeleteMsgVpnRestDeliveryPointRestConsumerTLSTrustedCommonNameOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnRestDeliveryPointRestConsumerTLSTrustedCommonNameDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
