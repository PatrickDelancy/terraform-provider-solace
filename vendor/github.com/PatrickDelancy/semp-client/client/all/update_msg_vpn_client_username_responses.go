...
func (o *UpdateMsgVpnClientUsernameOK) GetPayload() *models.MsgVpnClientUsernameResponse {
	return o.Payload
}
...
func (o *UpdateMsgVpnClientUsernameDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
