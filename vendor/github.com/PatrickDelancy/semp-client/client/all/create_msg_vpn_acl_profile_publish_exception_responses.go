...
func (o *CreateMsgVpnACLProfilePublishExceptionOK) GetPayload() *models.MsgVpnACLProfilePublishExceptionResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnACLProfilePublishExceptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
