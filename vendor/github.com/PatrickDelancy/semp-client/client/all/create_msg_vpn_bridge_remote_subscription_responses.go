...
func (o *CreateMsgVpnBridgeRemoteSubscriptionOK) GetPayload() *models.MsgVpnBridgeRemoteSubscriptionResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnBridgeRemoteSubscriptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
