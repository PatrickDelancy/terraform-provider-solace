...
func (o *DeleteDmrClusterLinkTLSTrustedCommonNameOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteDmrClusterLinkTLSTrustedCommonNameDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
