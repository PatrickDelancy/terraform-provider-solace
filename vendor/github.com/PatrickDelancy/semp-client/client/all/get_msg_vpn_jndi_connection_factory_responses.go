...
func (o *GetMsgVpnJndiConnectionFactoryOK) GetPayload() *models.MsgVpnJndiConnectionFactoryResponse {
	return o.Payload
}
...
func (o *GetMsgVpnJndiConnectionFactoryDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
