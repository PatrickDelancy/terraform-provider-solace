...
/* UpdateMsgVpnClientProfileParams contains all the parameters to send to the API endpoint
   for the update msg vpn client profile operation.
...
// WithDefaults hydrates default values in the update msg vpn client profile params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateMsgVpnClientProfileParams) WithDefaults() *UpdateMsgVpnClientProfileParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update msg vpn client profile params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateMsgVpnClientProfileParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the update msg vpn client profile params
func (o *UpdateMsgVpnClientProfileParams) WithOpaquePassword(opaquePassword *string) *UpdateMsgVpnClientProfileParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the update msg vpn client profile params
func (o *UpdateMsgVpnClientProfileParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamUpdateMsgVpnClientProfile binds the parameter select
func (o *UpdateMsgVpnClientProfileParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
