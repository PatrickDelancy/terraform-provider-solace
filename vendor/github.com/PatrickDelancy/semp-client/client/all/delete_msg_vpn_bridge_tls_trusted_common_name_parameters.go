...
/* DeleteMsgVpnBridgeTLSTrustedCommonNameParams contains all the parameters to send to the API endpoint
   for the delete msg vpn bridge Tls trusted common name operation.
...
// WithDefaults hydrates default values in the delete msg vpn bridge Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnBridgeTLSTrustedCommonNameParams) WithDefaults() *DeleteMsgVpnBridgeTLSTrustedCommonNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete msg vpn bridge Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnBridgeTLSTrustedCommonNameParams) SetDefaults() {
