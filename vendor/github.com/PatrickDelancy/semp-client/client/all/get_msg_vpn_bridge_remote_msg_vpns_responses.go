...
func (o *GetMsgVpnBridgeRemoteMsgVpnsOK) GetPayload() *models.MsgVpnBridgeRemoteMsgVpnsResponse {
	return o.Payload
}
...
func (o *GetMsgVpnBridgeRemoteMsgVpnsDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
