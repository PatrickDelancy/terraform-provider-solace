...
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesOK) GetPayload() *models.MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesResponse {
	return o.Payload
}
...
func (o *GetMsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixesDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
