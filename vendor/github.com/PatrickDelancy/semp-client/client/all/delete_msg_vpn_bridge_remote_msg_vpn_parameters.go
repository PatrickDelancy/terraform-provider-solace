...
/* DeleteMsgVpnBridgeRemoteMsgVpnParams contains all the parameters to send to the API endpoint
   for the delete msg vpn bridge remote msg vpn operation.
...
// WithDefaults hydrates default values in the delete msg vpn bridge remote msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnBridgeRemoteMsgVpnParams) WithDefaults() *DeleteMsgVpnBridgeRemoteMsgVpnParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete msg vpn bridge remote msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnBridgeRemoteMsgVpnParams) SetDefaults() {
