...
func (o *ReplaceMsgVpnMqttSessionOK) GetPayload() *models.MsgVpnMqttSessionResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnMqttSessionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
