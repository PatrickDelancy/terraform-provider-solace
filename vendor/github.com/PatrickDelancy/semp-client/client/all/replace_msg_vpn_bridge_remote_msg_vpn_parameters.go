...
/* ReplaceMsgVpnBridgeRemoteMsgVpnParams contains all the parameters to send to the API endpoint
   for the replace msg vpn bridge remote msg vpn operation.
...
// WithDefaults hydrates default values in the replace msg vpn bridge remote msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnBridgeRemoteMsgVpnParams) WithDefaults() *ReplaceMsgVpnBridgeRemoteMsgVpnParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the replace msg vpn bridge remote msg vpn params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnBridgeRemoteMsgVpnParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the replace msg vpn bridge remote msg vpn params
func (o *ReplaceMsgVpnBridgeRemoteMsgVpnParams) WithOpaquePassword(opaquePassword *string) *ReplaceMsgVpnBridgeRemoteMsgVpnParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the replace msg vpn bridge remote msg vpn params
func (o *ReplaceMsgVpnBridgeRemoteMsgVpnParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamReplaceMsgVpnBridgeRemoteMsgVpn binds the parameter select
func (o *ReplaceMsgVpnBridgeRemoteMsgVpnParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
