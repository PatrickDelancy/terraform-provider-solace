...
/* CreateMsgVpnACLProfileClientConnectExceptionParams contains all the parameters to send to the API endpoint
   for the create msg vpn Acl profile client connect exception operation.
...
// WithDefaults hydrates default values in the create msg vpn Acl profile client connect exception params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnACLProfileClientConnectExceptionParams) WithDefaults() *CreateMsgVpnACLProfileClientConnectExceptionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create msg vpn Acl profile client connect exception params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnACLProfileClientConnectExceptionParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create msg vpn Acl profile client connect exception params
func (o *CreateMsgVpnACLProfileClientConnectExceptionParams) WithOpaquePassword(opaquePassword *string) *CreateMsgVpnACLProfileClientConnectExceptionParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create msg vpn Acl profile client connect exception params
func (o *CreateMsgVpnACLProfileClientConnectExceptionParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateMsgVpnACLProfileClientConnectException binds the parameter select
func (o *CreateMsgVpnACLProfileClientConnectExceptionParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
