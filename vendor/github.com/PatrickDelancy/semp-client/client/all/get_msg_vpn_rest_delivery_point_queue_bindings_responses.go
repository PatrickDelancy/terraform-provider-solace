...
func (o *GetMsgVpnRestDeliveryPointQueueBindingsOK) GetPayload() *models.MsgVpnRestDeliveryPointQueueBindingsResponse {
	return o.Payload
}
...
func (o *GetMsgVpnRestDeliveryPointQueueBindingsDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
