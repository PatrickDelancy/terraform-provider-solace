...
func (o *ReplaceMsgVpnReplicatedTopicOK) GetPayload() *models.MsgVpnReplicatedTopicResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnReplicatedTopicDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
