...
/* CreateDmrClusterLinkParams contains all the parameters to send to the API endpoint
   for the create dmr cluster link operation.
...
// WithDefaults hydrates default values in the create dmr cluster link params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDmrClusterLinkParams) WithDefaults() *CreateDmrClusterLinkParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create dmr cluster link params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDmrClusterLinkParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create dmr cluster link params
func (o *CreateDmrClusterLinkParams) WithOpaquePassword(opaquePassword *string) *CreateDmrClusterLinkParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create dmr cluster link params
func (o *CreateDmrClusterLinkParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateDmrClusterLink binds the parameter select
func (o *CreateDmrClusterLinkParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
