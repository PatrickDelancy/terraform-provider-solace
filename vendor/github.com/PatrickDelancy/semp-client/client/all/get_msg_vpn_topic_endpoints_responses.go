...
func (o *GetMsgVpnTopicEndpointsOK) GetPayload() *models.MsgVpnTopicEndpointsResponse {
	return o.Payload
}
...
func (o *GetMsgVpnTopicEndpointsDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
