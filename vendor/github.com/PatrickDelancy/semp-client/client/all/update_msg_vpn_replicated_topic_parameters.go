...
/* UpdateMsgVpnReplicatedTopicParams contains all the parameters to send to the API endpoint
   for the update msg vpn replicated topic operation.
...
// WithDefaults hydrates default values in the update msg vpn replicated topic params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateMsgVpnReplicatedTopicParams) WithDefaults() *UpdateMsgVpnReplicatedTopicParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update msg vpn replicated topic params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateMsgVpnReplicatedTopicParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the update msg vpn replicated topic params
func (o *UpdateMsgVpnReplicatedTopicParams) WithOpaquePassword(opaquePassword *string) *UpdateMsgVpnReplicatedTopicParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the update msg vpn replicated topic params
func (o *UpdateMsgVpnReplicatedTopicParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamUpdateMsgVpnReplicatedTopic binds the parameter select
func (o *UpdateMsgVpnReplicatedTopicParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
