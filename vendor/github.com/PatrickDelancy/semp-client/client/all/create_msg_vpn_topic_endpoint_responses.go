...
func (o *CreateMsgVpnTopicEndpointOK) GetPayload() *models.MsgVpnTopicEndpointResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnTopicEndpointDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
