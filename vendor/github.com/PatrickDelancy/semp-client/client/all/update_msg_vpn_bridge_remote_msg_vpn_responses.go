...
func (o *UpdateMsgVpnBridgeRemoteMsgVpnOK) GetPayload() *models.MsgVpnBridgeRemoteMsgVpnResponse {
	return o.Payload
}
...
func (o *UpdateMsgVpnBridgeRemoteMsgVpnDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
