...
func (o *CreateMsgVpnACLProfileSubscribeExceptionOK) GetPayload() *models.MsgVpnACLProfileSubscribeExceptionResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnACLProfileSubscribeExceptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
