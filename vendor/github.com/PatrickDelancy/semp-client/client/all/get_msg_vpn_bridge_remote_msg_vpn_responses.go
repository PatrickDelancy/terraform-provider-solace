...
func (o *GetMsgVpnBridgeRemoteMsgVpnOK) GetPayload() *models.MsgVpnBridgeRemoteMsgVpnResponse {
	return o.Payload
}
...
func (o *GetMsgVpnBridgeRemoteMsgVpnDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
