...
func (o *GetMsgVpnBridgeTLSTrustedCommonNameOK) GetPayload() *models.MsgVpnBridgeTLSTrustedCommonNameResponse {
	return o.Payload
}
...
func (o *GetMsgVpnBridgeTLSTrustedCommonNameDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
