...
func (o *ReplaceMsgVpnMqttRetainCacheOK) GetPayload() *models.MsgVpnMqttRetainCacheResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnMqttRetainCacheDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
