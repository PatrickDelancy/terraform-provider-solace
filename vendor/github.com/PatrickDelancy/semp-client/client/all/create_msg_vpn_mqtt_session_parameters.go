...
/* CreateMsgVpnMqttSessionParams contains all the parameters to send to the API endpoint
   for the create msg vpn mqtt session operation.
...
// WithDefaults hydrates default values in the create msg vpn mqtt session params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnMqttSessionParams) WithDefaults() *CreateMsgVpnMqttSessionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create msg vpn mqtt session params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnMqttSessionParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create msg vpn mqtt session params
func (o *CreateMsgVpnMqttSessionParams) WithOpaquePassword(opaquePassword *string) *CreateMsgVpnMqttSessionParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create msg vpn mqtt session params
func (o *CreateMsgVpnMqttSessionParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateMsgVpnMqttSession binds the parameter select
func (o *CreateMsgVpnMqttSessionParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
