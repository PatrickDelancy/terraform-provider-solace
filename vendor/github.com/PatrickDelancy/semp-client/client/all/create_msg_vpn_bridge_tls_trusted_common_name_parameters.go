...
/* CreateMsgVpnBridgeTLSTrustedCommonNameParams contains all the parameters to send to the API endpoint
   for the create msg vpn bridge Tls trusted common name operation.
...
// WithDefaults hydrates default values in the create msg vpn bridge Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnBridgeTLSTrustedCommonNameParams) WithDefaults() *CreateMsgVpnBridgeTLSTrustedCommonNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create msg vpn bridge Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateMsgVpnBridgeTLSTrustedCommonNameParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create msg vpn bridge Tls trusted common name params
func (o *CreateMsgVpnBridgeTLSTrustedCommonNameParams) WithOpaquePassword(opaquePassword *string) *CreateMsgVpnBridgeTLSTrustedCommonNameParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create msg vpn bridge Tls trusted common name params
func (o *CreateMsgVpnBridgeTLSTrustedCommonNameParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateMsgVpnBridgeTLSTrustedCommonName binds the parameter select
func (o *CreateMsgVpnBridgeTLSTrustedCommonNameParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
