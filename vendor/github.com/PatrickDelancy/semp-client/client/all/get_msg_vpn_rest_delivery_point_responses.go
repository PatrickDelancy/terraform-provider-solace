...
func (o *GetMsgVpnRestDeliveryPointOK) GetPayload() *models.MsgVpnRestDeliveryPointResponse {
	return o.Payload
}
...
func (o *GetMsgVpnRestDeliveryPointDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
