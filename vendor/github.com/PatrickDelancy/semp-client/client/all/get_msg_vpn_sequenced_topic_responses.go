...
func (o *GetMsgVpnSequencedTopicOK) GetPayload() *models.MsgVpnSequencedTopicResponse {
	return o.Payload
}
...
func (o *GetMsgVpnSequencedTopicDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
