...
/* CreateDmrClusterLinkTLSTrustedCommonNameParams contains all the parameters to send to the API endpoint
   for the create dmr cluster link Tls trusted common name operation.
...
// WithDefaults hydrates default values in the create dmr cluster link Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDmrClusterLinkTLSTrustedCommonNameParams) WithDefaults() *CreateDmrClusterLinkTLSTrustedCommonNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create dmr cluster link Tls trusted common name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDmrClusterLinkTLSTrustedCommonNameParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the create dmr cluster link Tls trusted common name params
func (o *CreateDmrClusterLinkTLSTrustedCommonNameParams) WithOpaquePassword(opaquePassword *string) *CreateDmrClusterLinkTLSTrustedCommonNameParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the create dmr cluster link Tls trusted common name params
func (o *CreateDmrClusterLinkTLSTrustedCommonNameParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamCreateDmrClusterLinkTLSTrustedCommonName binds the parameter select
func (o *CreateDmrClusterLinkTLSTrustedCommonNameParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
