...
func (o *UpdateMsgVpnReplicatedTopicOK) GetPayload() *models.MsgVpnReplicatedTopicResponse {
	return o.Payload
}
...
func (o *UpdateMsgVpnReplicatedTopicDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
