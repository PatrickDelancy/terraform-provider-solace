...
func (o *GetMsgVpnAuthorizationGroupOK) GetPayload() *models.MsgVpnAuthorizationGroupResponse {
	return o.Payload
}
...
func (o *GetMsgVpnAuthorizationGroupDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
