...
func (o *GetMsgVpnRestDeliveryPointRestConsumerOK) GetPayload() *models.MsgVpnRestDeliveryPointRestConsumerResponse {
	return o.Payload
}
...
func (o *GetMsgVpnRestDeliveryPointRestConsumerDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
