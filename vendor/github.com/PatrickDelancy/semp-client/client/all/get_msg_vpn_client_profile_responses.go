...
func (o *GetMsgVpnClientProfileOK) GetPayload() *models.MsgVpnClientProfileResponse {
	return o.Payload
}
...
func (o *GetMsgVpnClientProfileDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
