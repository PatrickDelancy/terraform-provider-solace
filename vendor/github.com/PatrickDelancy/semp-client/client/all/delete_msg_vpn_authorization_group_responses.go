...
func (o *DeleteMsgVpnAuthorizationGroupOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnAuthorizationGroupDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
