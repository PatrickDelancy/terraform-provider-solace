...
func (o *DeleteMsgVpnQueueSubscriptionOK) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
...
func (o *DeleteMsgVpnQueueSubscriptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
