...
/* ReplaceMsgVpnMqttSessionSubscriptionParams contains all the parameters to send to the API endpoint
   for the replace msg vpn mqtt session subscription operation.
...
// WithDefaults hydrates default values in the replace msg vpn mqtt session subscription params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnMqttSessionSubscriptionParams) WithDefaults() *ReplaceMsgVpnMqttSessionSubscriptionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the replace msg vpn mqtt session subscription params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReplaceMsgVpnMqttSessionSubscriptionParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the replace msg vpn mqtt session subscription params
func (o *ReplaceMsgVpnMqttSessionSubscriptionParams) WithOpaquePassword(opaquePassword *string) *ReplaceMsgVpnMqttSessionSubscriptionParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the replace msg vpn mqtt session subscription params
func (o *ReplaceMsgVpnMqttSessionSubscriptionParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamReplaceMsgVpnMqttSessionSubscription binds the parameter select
func (o *ReplaceMsgVpnMqttSessionSubscriptionParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
