...
func (o *ReplaceMsgVpnMqttSessionSubscriptionOK) GetPayload() *models.MsgVpnMqttSessionSubscriptionResponse {
	return o.Payload
}
...
func (o *ReplaceMsgVpnMqttSessionSubscriptionDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
