...
func (o *CreateMsgVpnAuthorizationGroupOK) GetPayload() *models.MsgVpnAuthorizationGroupResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnAuthorizationGroupDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
