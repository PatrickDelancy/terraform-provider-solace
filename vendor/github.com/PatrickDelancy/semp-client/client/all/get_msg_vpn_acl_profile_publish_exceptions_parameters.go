...
/* GetMsgVpnACLProfilePublishExceptionsParams contains all the parameters to send to the API endpoint
   for the get msg vpn Acl profile publish exceptions operation.
...
// WithDefaults hydrates default values in the get msg vpn Acl profile publish exceptions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnACLProfilePublishExceptionsParams) WithDefaults() *GetMsgVpnACLProfilePublishExceptionsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get msg vpn Acl profile publish exceptions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnACLProfilePublishExceptionsParams) SetDefaults() {
	var (
		countDefault = int64(10)
	)

	val := GetMsgVpnACLProfilePublishExceptionsParams{
		Count: &countDefault,
	}
...
// WithOpaquePassword adds the opaquePassword to the get msg vpn Acl profile publish exceptions params
func (o *GetMsgVpnACLProfilePublishExceptionsParams) WithOpaquePassword(opaquePassword *string) *GetMsgVpnACLProfilePublishExceptionsParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the get msg vpn Acl profile publish exceptions params
func (o *GetMsgVpnACLProfilePublishExceptionsParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamGetMsgVpnACLProfilePublishExceptions binds the parameter select
func (o *GetMsgVpnACLProfilePublishExceptionsParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
...
// bindParamGetMsgVpnACLProfilePublishExceptions binds the parameter where
func (o *GetMsgVpnACLProfilePublishExceptionsParams) bindParamWhere(formats strfmt.Registry) []string {
	whereIR := o.Where
