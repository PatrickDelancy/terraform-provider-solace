...
/* GetMsgVpnReplicatedTopicsParams contains all the parameters to send to the API endpoint
   for the get msg vpn replicated topics operation.
...
// WithDefaults hydrates default values in the get msg vpn replicated topics params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnReplicatedTopicsParams) WithDefaults() *GetMsgVpnReplicatedTopicsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get msg vpn replicated topics params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMsgVpnReplicatedTopicsParams) SetDefaults() {
	var (
		countDefault = int64(10)
	)

	val := GetMsgVpnReplicatedTopicsParams{
		Count: &countDefault,
	}
...
// WithOpaquePassword adds the opaquePassword to the get msg vpn replicated topics params
func (o *GetMsgVpnReplicatedTopicsParams) WithOpaquePassword(opaquePassword *string) *GetMsgVpnReplicatedTopicsParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the get msg vpn replicated topics params
func (o *GetMsgVpnReplicatedTopicsParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamGetMsgVpnReplicatedTopics binds the parameter select
func (o *GetMsgVpnReplicatedTopicsParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
...
// bindParamGetMsgVpnReplicatedTopics binds the parameter where
func (o *GetMsgVpnReplicatedTopicsParams) bindParamWhere(formats strfmt.Registry) []string {
	whereIR := o.Where
