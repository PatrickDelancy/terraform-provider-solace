...
func (o *CreateMsgVpnRestDeliveryPointOK) GetPayload() *models.MsgVpnRestDeliveryPointResponse {
	return o.Payload
}
...
func (o *CreateMsgVpnRestDeliveryPointDefault) GetPayload() *models.SempMetaOnlyResponse {
	return o.Payload
}
