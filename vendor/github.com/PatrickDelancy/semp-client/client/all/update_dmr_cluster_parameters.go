...
/* UpdateDmrClusterParams contains all the parameters to send to the API endpoint
   for the update dmr cluster operation.
...
// WithDefaults hydrates default values in the update dmr cluster params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateDmrClusterParams) WithDefaults() *UpdateDmrClusterParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update dmr cluster params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateDmrClusterParams) SetDefaults() {
...
// WithOpaquePassword adds the opaquePassword to the update dmr cluster params
func (o *UpdateDmrClusterParams) WithOpaquePassword(opaquePassword *string) *UpdateDmrClusterParams {
	o.SetOpaquePassword(opaquePassword)
	return o
}

// SetOpaquePassword adds the opaquePassword to the update dmr cluster params
func (o *UpdateDmrClusterParams) SetOpaquePassword(opaquePassword *string) {
...
// bindParamUpdateDmrCluster binds the parameter select
func (o *UpdateDmrClusterParams) bindParamSelect(formats strfmt.Registry) []string {
	selectIR := o.Select
