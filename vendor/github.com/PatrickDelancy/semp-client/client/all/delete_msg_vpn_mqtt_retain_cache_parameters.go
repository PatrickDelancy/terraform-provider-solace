...
/* DeleteMsgVpnMqttRetainCacheParams contains all the parameters to send to the API endpoint
   for the delete msg vpn mqtt retain cache operation.
...
// WithDefaults hydrates default values in the delete msg vpn mqtt retain cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnMqttRetainCacheParams) WithDefaults() *DeleteMsgVpnMqttRetainCacheParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete msg vpn mqtt retain cache params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMsgVpnMqttRetainCacheParams) SetDefaults() {
