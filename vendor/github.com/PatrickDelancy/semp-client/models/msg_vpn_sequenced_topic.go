...
// ContextValidate validates this msg vpn sequenced topic based on context it is used
func (m *MsgVpnSequencedTopic) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
