...
func (m *MsgVpnACLProfile) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSubscribeShareNameDefaultAction(formats); err != nil {
		res = append(res, err)
	}
...
func (m *MsgVpnACLProfile) validateClientConnectDefaultActionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, msgVpnAclProfileTypeClientConnectDefaultActionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *MsgVpnACLProfile) validatePublishTopicDefaultActionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, msgVpnAclProfileTypePublishTopicDefaultActionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
var msgVpnAclProfileTypeSubscribeShareNameDefaultActionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		msgVpnAclProfileTypeSubscribeShareNameDefaultActionPropEnum = append(msgVpnAclProfileTypeSubscribeShareNameDefaultActionPropEnum, v)
	}
}

const (

	// MsgVpnACLProfileSubscribeShareNameDefaultActionAllow captures enum value "allow"
	MsgVpnACLProfileSubscribeShareNameDefaultActionAllow string = "allow"

	// MsgVpnACLProfileSubscribeShareNameDefaultActionDisallow captures enum value "disallow"
	MsgVpnACLProfileSubscribeShareNameDefaultActionDisallow string = "disallow"
)

// prop value enum
func (m *MsgVpnACLProfile) validateSubscribeShareNameDefaultActionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, msgVpnAclProfileTypeSubscribeShareNameDefaultActionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MsgVpnACLProfile) validateSubscribeShareNameDefaultAction(formats strfmt.Registry) error {
	if swag.IsZero(m.SubscribeShareNameDefaultAction) { // not required
		return nil
	}

	// value enum
	if err := m.validateSubscribeShareNameDefaultActionEnum("subscribeShareNameDefaultAction", "body", m.SubscribeShareNameDefaultAction); err != nil {
		return err
	}
...
func (m *MsgVpnACLProfile) validateSubscribeTopicDefaultActionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, msgVpnAclProfileTypeSubscribeTopicDefaultActionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this msg vpn Acl profile based on context it is used
func (m *MsgVpnACLProfile) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
