...
// ContextValidate validates this msg vpn client profile links based on context it is used
func (m *MsgVpnClientProfileLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
