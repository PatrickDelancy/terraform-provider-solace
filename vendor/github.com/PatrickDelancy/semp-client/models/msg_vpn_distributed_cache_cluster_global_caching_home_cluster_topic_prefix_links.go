...
// ContextValidate validates this msg vpn distributed cache cluster global caching home cluster topic prefix links based on context it is used
func (m *MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
