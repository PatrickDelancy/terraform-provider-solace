...
// ContextValidate validate this msg vpn queue subscriptions response based on the context it is used
func (m *MsgVpnQueueSubscriptionsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MsgVpnQueueSubscriptionsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsgVpnQueueSubscriptionsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MsgVpnQueueSubscriptionsResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
